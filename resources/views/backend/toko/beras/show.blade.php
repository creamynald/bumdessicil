    ...
    <div class="content content-boxed content-full overflow-hidden">
        ...
        <div class="py-5 text-center">
            ...
            <h2 class="fs-6 fw-medium text-muted mb-0">
                Terimakasih telah berbelanja ditoko kami, lengkapi form dibawah untuk lanjut ke pemesanan.
            </h2>
        </div>
        <!-- END Header -->

        <!-- Checkout -->
        <form action="op_checkout.html" method="POST" onsubmit="return false;">
            <div class="row">
                <!-- Order Info -->
                <div class="col-xl-7">
                    <!-- Shipping Address -->
                            ...
                            <div class="mb-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="checkout-billing-address-same" name="checkout-billing-address-same" checked>
                                    <label class="form-check-label fw-medium text-muted"
                                        for="checkout-billing-address-same">Billing address is the same</label>
                                </div>
                            </div>
                        </div>
                    </div>
